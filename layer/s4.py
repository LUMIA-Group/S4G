...
# Try CUDA extension
try:
    from layer.state_spaces.extensions.kernels.cauchy import cauchy_mult as cauchy_cuda
    from layer.state_spaces.extensions.kernels.vandermonde import log_vandermonde_cuda
